...
response = client.responses.create(
    model="gpt-4o",
    input="Translate all the words that are between the commas: \"\"\"" + word + "\"\"\". As output give me exactly: on each line the language code and translated word, csv format. Translate to the following languages:\n" + ",".join(languages),
)

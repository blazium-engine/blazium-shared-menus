...
func _enter_tree() -> void:
	...
	ProjectSettings.set("gui/theme/base_color", Color("141a21"))
	ProjectSettings.set("gui/theme/accent_color", Color("3594d4"))
